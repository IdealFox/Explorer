...
u16 Motor_Speed_Set(u16 Speed_Value,u16 Turn_Value)
{
	...
	{	
		Speed_Value-=2300;
		Convert=(float)Speed_Value/1800;
...
void Motor_Control(void)
{
	...
	u16 Speed,Turn;			
	Speed=AD_Final_Value[1];							//速度控制AD
	Turn=AD_Final_Value[2];								//旋转控制AD
	
	if(Speed>=2300||Speed<=1800)		//速度参数值溢出
	{	

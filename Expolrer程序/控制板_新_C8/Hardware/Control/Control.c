...
void Motor_Control(void)
{
	...
	switch(Motor_Space)
	{
		...
		case 4:	Send_Data.Motor_State=0X09;		//左移
						...
						break;
		//区间(全向移动控制)
		case 5:	Motor_Space_Move_Control(1);
						Motor_Space_Turn_Control(1);
						break;
		case 6:	Motor_Space_Move_Control(2);
						Motor_Space_Turn_Control(2);
						break;
		case 7:	Motor_Space_Move_Control(3);
						Motor_Space_Turn_Control(3);
						break;
		case 8:	Motor_Space_Move_Control(4);
						Motor_Space_Turn_Control(4);
						break;
		case 9:	Motor_Space_Move_Control(5);
						Motor_Space_Turn_Control(5);
						break;
		case 10:Motor_Space_Move_Control(6);
						Motor_Space_Turn_Control(6);
						break;
		case 11:Motor_Space_Move_Control(7);
						Motor_Space_Turn_Control(7);
						break;
		case 12:Motor_Space_Move_Control(8);

...
#define NRF24L01_CE(X)		GPIO_WriteBit(GPIOB,GPIO_Pin_2,(BitAction)(X))
...
void NRF24L01_Interrupt_Init(u8 PreemptionPriority,u8 SubPriority)
{
	...
	GPIO_EXTILineConfig(GPIO_PortSourceGPIOA,GPIO_PinSource12);			//GPIO通道选择，PA12
	
	//外部中断配置
	EXTI_InitTypeDef EXTI_InitStruct;
	EXTI_InitStruct.EXTI_Line			=EXTI_Line12;											//通道0
	...
	NVIC_InitStruct.NVIC_IRQChannel										=EXTI15_10_IRQn;				//外部中断通道10-15
...
{	
	...
	if((Test_Addr&0X8F)!=NRF_24L01_Channel)						//验证初始化是否成功
	{	return 1;}

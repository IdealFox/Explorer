...
//	LCD_ShowPicture(90,0,64,64,Reimu);
	LCD_ShowPicture(90,64,64,64,Marisa);
	while(1)
	{
...
void LCD_Show_Slave_Connect(void)
{
	...
	if(NRF24L01_State==6)
	{
		LCD_ShowString(95,6,"Slave_",GREEN,WHITE,12,1);
		LCD_ShowString(95,16,"Connect",GREEN,WHITE,12,0);
	}
	if(NRF24L01_State==7)
	{
		LCD_ShowString(95,6,"Slave_",RED,WHITE,12,1);
...
void LCD_Show_Motor_Data(void)
{
	...
	LCD_ShowString(95,40,"Control",BLACK,WHITE,12,1);
	...
	if(Send_Data.B_Motor_Control==0)//无刷电机状态
...
void LCD_Show_Servo_Data(void)
{
	...
	LCD_ShowString(2,102,"           ",WHITE,WHITE,16,0);
